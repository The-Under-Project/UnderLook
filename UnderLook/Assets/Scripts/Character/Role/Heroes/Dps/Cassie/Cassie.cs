...
namespace Player
{
    public class Cassie : Dps
    {
        ...
        public void ApllyCard(Card upgrade)
        {
            ...
            TimeTP -= upgrade.durationCap1;
            GetComponentInChildren<Weapon.Hitscan>().gunDamage = (int)(GetComponentInChildren<Weapon.Hitscan>().gunDamage*(1 + upgrade.ultimateDamge / 100));
